...
class Scenario(BaseScenario):
    ...
    def reward(self, agent, world):
        rew = 0
        # ******** actually don't use reward in this file
        # two_dists = []
    ...
    def observation(self, agent, world):
        ...
        agent_vel = []
        for agent in world.agents:
            agent_pos.append(agent.state.p_pos) # [[a1_x, a1_y], [a2_x, a2_y]]
...
#            other_pos.append(other.state.p_pos)
                # [agent.state.p_vel] +
        # ****************  output [agent1.state.p_vel, agent2.state.p_vel, agent1.state.p_pos, agent2.state.p_pos, entity1_pos, entity2_pos ]
        return np.concatenate( agent_vel + agent_pos  + entity_pos )
